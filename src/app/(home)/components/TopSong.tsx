        ...
        <div className="w-full h-64 relative overflow-hidden rounded-xl group cursor-pointer border-2 border-transparent hover:border-emerald-600">
            ...
            <div className="absolute top-0 left-0 w-full h-full bg-black/60 backdrop-blur-xl p-6 flex flex-col justify-center">
                ...
                <div className="flex items-center justify-start gap-4">
                    <Image src={trackInfo.album.cover_medium} alt={trackInfo.title} className="rounded-xl" width={180} height={180} />
                    <div className="max-w-xl">
                        ...
                        <div className="flex mt-6">
                            <button className="translate-y-6 opacity-0 group-hover:translate-y-0 group-hover:opacity-100  w-12 h-12 bg-white/10 border-white border-2 rounded-full flex items-center justify-center text-white/80 hover:bg-white hover:text-black font-bold cursor-pointer transition-all">
